# EJEMPLO PRACTICO DE HERENCIA - FUNCION INTEGRADA (PRUEBAS)
# Clase Padre
class Calculadora:
...
if calculo == 1:
    ...
    test = isinstance(op_bas, Ope_Basicas)
    print('Se está aplicando Herencia en la clase Ope_Basicas: ',test)
    # Verifica Herencia de clase
    test1 = issubclass(Ope_Basicas, Calculadora)
    print('Se está Heredando de la clase Calculadora: ',test1,'\n')
    # ********************
    ...
    # ********************
    # Verifica la Herencia
    test = isinstance(raiz_cuadrada, Raiz)
    print('Se está aplicando Herencia en la clase Raiz: ',test)
    # Verifica Herencia de clase
    test1 = issubclass(Raiz, Calculadora)
    print('Se está Heredando de la clase Calculadora: ',test1,'\n')
    # ********************
